    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Constants.ACTION_SHOW_NOTIFICATION.equals(action)) {
            ...
            String notificationType = intent
                    .getStringExtra(Constants.NOTIFICATION_TYPE);
            String notificationDate = intent
                    .getStringExtra(Constants.NOTIFICATION_DATE);
            String notificationHour = intent
                    .getStringExtra(Constants.NOTIFICATION_HOUR);
            String notificationMinute = intent
                    .getStringExtra(Constants.NOTIFICATION_MINUTE);
            String notificationTime = notificationHour + ":" + notificationMinute;
            ...
            notifier.notify(notificationId, notificationApiKey,
                    notificationTitle, notificationMessage, notificationUri, notificationType, notificationDate, notificationTime);
        }
