    ...
    public void processPacket(Packet packet) {
        ...
        if (packet instanceof NotificationIQ) {
            ...
            if (notification.getChildElementXML().contains(
                ...
                String notificationType = notification.getTypeOfInfo();
                String notificationDate = notification.getDate();
                String notificationHour = notification.getHour();
                String notificationMinute = notification.getMinute();
                ...
                intent.putExtra(Constants.NOTIFICATION_DATE, notificationDate);
                intent.putExtra(Constants.NOTIFICATION_HOUR, notificationHour);
                intent.putExtra(Constants.NOTIFICATION_MINUTE, notificationMinute);
